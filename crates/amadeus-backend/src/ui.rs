...
impl AgentUiService {
    ...
    pub fn is_model_ready(&self) -> bool {
        ...
        crate::llm::llama_cpp::is_handle_loaded()
    }
    ...
    pub fn reload_config(&self) {
        ...
        match AgentRuntimeConfig::load(Some(workspace_root), None) {
            Ok(new_config) => {
                ...
                if new_config.provider != crate::config::LlmProvider::LlamaCpp {
                    crate::llm::llama_cpp::release_persistent_handle();
                }
...
mod tests {
    use super::*;
    use crate::session::{SessionMessage, SessionToolCall};
