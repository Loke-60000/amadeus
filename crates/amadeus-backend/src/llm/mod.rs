...
pub fn build_model_client(
    ...
    match config.provider {
        ...
        LlmProvider::LlamaCpp => Ok(Box::new(llama_cpp::LlamaCppClient::new(config)?)),
    }
}
